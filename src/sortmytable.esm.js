...
class SortMyTable {
    ...
    createHeaderButtons() {
        ...
        _this.settings.getSortableHeaders(_this.tableElement).forEach(function(thElement, i){
            ...
            button.addEventListener('click', function(){
                let currentSort = thElement.getAttribute('aria-sort');
    ...
    storeInitialSortOrder() {
        let sortableHeaders = this.settings.getSortableHeaders(this.tableElement);
        let initialSortColumn = filter(sortableHeaders, '[aria-sort]');
    ...
    sort(column, direction) {
        ...
        if ( typeof column === 'undefined' ) {
            ...
            let rows = Array.from(
                ...
                let valA = _this.settings.getSortableValue(rowA.children[column]);
                let valB = _this.settings.getSortableValue(rowB.children[column]);
 ...
 * @returns {Boolean}
 */
let isHTMLElement = function(thing) {
 ...
 * @returns {HTMLElement[]}
 */
let filter = function filter(elements, selector) {
 ...
 */
let wrapInner = function wrapInner(parent, wrapper = 'div') {
